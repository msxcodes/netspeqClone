...
function ExpCard() {
  return (
    <div className="grid grid-cols-3 w-[60vw] mx-auto py-16">
      <div className="flex flex-col justify-evenly items-center border border-gray-500">
      ...
      <div>
        <h2 className="text-3xl font-semibold p-8 pt-12">
          {" "}
      ...
      <div>
        <p className="text-xs leading-5 text-gray-600 mb-3">
          ...
          operating in Gangtok, Sikkim since 2014 and has etched its footprints
          by delivering comprehensive, top-quality and cost-effective solutions
          for our clients. We believe that catering to any client for IT-related
